...
class Card(db.Model):
    ...
    type = db.relationship(
        "CardType", back_populates="cards", uselist=False, lazy=False
    )
    ...
    offensiveAgainst = db.relationship(
        "Defence",
        foreign_keys="Defence.offenceCardId",
        back_populates="offence",
        lazy=False,
    )
    defensiveFrom = db.relationship(
        "Defence",
        foreign_keys="Defence.defenceCardId",
        back_populates="defence",
        lazy=False,
    )
